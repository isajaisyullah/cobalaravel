    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="form-group mb-3">
                ...
                <input name="nama" type="text" class="form-control mt-2" id="exampleInputEmail1" aria-describedby="EmailHelp" 
                placeholder="Nama Mahasiswa" value="{{ $mahasiswa->nama }}">
            </div>
            <div class="form-group mb-3">
                <label for="exampleInputEmail1">NIM</label>
                <input name="nim" type="text" class="form-control mt-2" id="exampleInputEmail1" aria-describedby="EmailHelp" 
